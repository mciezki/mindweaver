import { MessageResponse, PaginatedMessages, PaginationOptions, ThreadCommentsList } from '@mindweave/types';
...
export const getConversationMessages = async (
    ...
    try {
        ...
        const messages: MessageResponse[] = messagesFromDb.map(mapMessageToResponse)
