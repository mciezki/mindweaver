...
import { resetPasswordSchema, ResetPasswordSchema, ResetPasswordRequest } from '@/utils/validators/reset-password-schema';
...
const ResetPasswordPage = () => {
    ...
    const { mutate: resetPassword, isPending, isError, error } = useResetPasswordMutation();
            ...
            <FormContainer>
                ...
                {isError && (
                    <Alert severity="error">
                        {isError && (error as any)?.response?.data?.message || t('reset_password.error_message')}
                    </Alert>
                )}
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <TextField
                        ...
                        margin="normal"
                        error={!!errors.token}
                        helperText={errors.token ? t('reset_password.form.token.required') : ''}
                    />
                    <TextField
                        ...
                        helperText={errors.newPassword ? t('reset_password.form.confirm_password.required') : ''}
                    />
                    <TextField
                        ...
                        helperText={errors.confirmPassword ? t('reset_password.form.confirm_password.required') : ''}
                    />
                    <Button
                        type="submit"
                        variant="contained"
